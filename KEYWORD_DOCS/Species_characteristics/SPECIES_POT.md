...
the species in the [POSITIONS_FRAC](k_positions_frac_castep.htm) or [POSITIONS_ABS](k_positions_abs_castep.htm) block.
...
The _filename_ qualifier in the SPECIES_POT block may be either the name of the file that contains the tabulated pseudopotential on a
...
Not all of the species present in the system have to appear in the SPECIES_POT block. Any that are not present will be assigned the default
...
[POSITIONS_FRAC](k_positions_frac_castep.htm)

[POSITIONS_ABS](k_positions_abs_castep.htm)
