...
**Source:** https://www.tcm.phy.cam.ac.uk/castep/documentation/WebHelp/content/modules/castep/keywords/k_sedc_lambda_obs_castep.htm

**Group:** Electronic parameters

---

# SEDC\_LAMBDA\_OBS (.param)
...
This keyword controls the λ value for the damping function in the Ortmann-Bechstedt-Schmidt (OBS) dispersion correction scheme.
