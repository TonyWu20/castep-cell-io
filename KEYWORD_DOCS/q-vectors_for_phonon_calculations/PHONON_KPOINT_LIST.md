...
**Source:** https://www.tcm.phy.cam.ac.uk/castep/documentation/WebHelp/content/modules/castep/keywords/k_phonon_kpoint_list_castep.htm

**Group:** q-vectors for phonon calculations

---

# PHONON\_KPOINT\_LIST (.cell)
...
This data block contains a list of k-points at which the Brillouin zone will be sampled during phonon calculations, along with the
associated weights. It has the same format as [KPOINTS\_LIST](k_kpoints_list_castep.htm).
