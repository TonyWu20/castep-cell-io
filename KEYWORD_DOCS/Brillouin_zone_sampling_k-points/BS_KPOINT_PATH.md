...
**Source:** https://www.tcm.phy.cam.ac.uk/castep/documentation/WebHelp/content/modules/castep/keywords/k_bs_kpoint_path_castep.htm

**Group:** Brillouin zone sampling k-points

---

# BS\_KPOINT\_PATH (.cell)
...
This data block defines a path through reciprocal space, on which lie the k-points used for non-self consistent band structure calculations.
...
[BS\_KPOINT\_PATH\_SPACING](k_bs_kpoint_path_spacing_castep.htm).
