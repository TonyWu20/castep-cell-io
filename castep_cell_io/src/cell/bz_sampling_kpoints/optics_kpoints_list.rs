...
/// A line of block `OpticsKpointsList`
...
/// Represents the OPTICS_KPOINTS_LIST block.
///
/// Contains a list of k-points and their weights for optical properties calculations.
/// # Format:
/// %BLOCK OPTICS_KPOINTS_LIST
///    R1i R1j R1k R1w
///    R2i R2j R2k R2w
/// ...
